...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'fade-in':  'fadeIn 0.25s cubic-bezier(0.25, 1, 0.5, 1) both',
        'slide-up': 'slideUp 0.3s cubic-bezier(0.25, 1, 0.5, 1) both',
        'scale-in': 'scaleIn 0.25s cubic-bezier(0.25, 1, 0.5, 1) both',
        'pulse-gold': 'pulseGold 2s ease-in-out infinite',
      },
      keyframes: {
        fadeIn:    { from: { opacity: '0' }, to: { opacity: '1' } },
        slideUp:   { from: { opacity: '0', transform: 'translate3d(0, 16px, 0)' }, to: { opacity: '1', transform: 'translate3d(0, 0, 0)' } },
        scaleIn:   { from: { opacity: '0', transform: 'scale3d(0.95, 0.95, 1)' }, to: { opacity: '1', transform: 'scale3d(1, 1, 1)' } },
